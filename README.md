...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-ggplotify-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-ggplotify-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-ggplotify-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-ggplotify-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-ggplotify-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-ggplotify-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-ggplotify` can be installed with:

```
conda install r-ggplotify
```

It is possible to list all of the versions of `r-ggplotify` available on your platform with:
